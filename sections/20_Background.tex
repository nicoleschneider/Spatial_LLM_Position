...
\osullikomment{Traditionally: Qualitative Spatial Reasoning -- all that gross CSP stuff from that lit review with the giant tables. I.e. First Order Logic stuff.}
...
\osullikomment{Nothing I've seen sorry, outside of the super simplistic near/far stuff from SIGSPATIAL.}