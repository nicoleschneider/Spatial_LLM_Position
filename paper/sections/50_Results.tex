...
The returned results for the cyclic order relation  prompts (figure~\ref{fig:order} show what amounts to random guessing of `clockwise' and `counterclockwise' by the models.
